...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-brand-primary text-black hover:bg-brand-accent shadow-md hover:shadow-lg transition-all duration-300",
        destructive:
        ...
        glass: "bg-glass-bg border border-white/20 hover:bg-white/40 text-foreground backdrop-blur-md shadow-sm"
      },
      size: {
