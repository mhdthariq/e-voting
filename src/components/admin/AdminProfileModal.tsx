  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-9999 flex items-center justify-center pointer-events-none p-4">
        <div
          className={`pointer-events-auto w-full max-w-md rounded-2xl p-6 shadow-2xl border relative flex flex-col ${darkMode ? "bg-neutral-900 border-emerald-700 text-emerald-100" : "bg-white border-gray-200 text-gray-900"}`}
        >
          ...
          <div className="space-y-4 mb-8">
            <div>
              ...
              <input
                className={`w-full px-4 py-2.5 rounded-lg border outline-none ${darkMode ? "bg-neutral-800 border-emerald-800" : "bg-gray-50 border-gray-300"}`}
                value={username}
            ...
            <div>
              ...
              <input
                disabled
                className={`w-full px-4 py-2.5 rounded-lg border opacity-60 cursor-not-allowed ${darkMode ? "bg-neutral-800 border-emerald-800" : "bg-gray-50 border-gray-300"}`}
                value={user?.email || ""}
              />
            </div>
          </div>
          ...
          <div className="space-y-3 pt-6 border-t border-gray-200 dark:border-gray-800">
            <button
              ...
              className={`w-full flex items-center justify-between px-4 py-3 rounded-lg border transition-all ${darkMode ? "bg-neutral-800/50 border-emerald-800 hover:bg-neutral-800" : "bg-gray-50 border-gray-200 hover:bg-gray-100"}`}
            >
            ...
            <button
              ...
              className={`w-full flex items-center justify-between px-4 py-3 rounded-lg border transition-all ${darkMode ? "bg-red-900/10 border-red-900/30 text-red-400 hover:bg-red-900/20" : "bg-red-50 border-red-100 text-red-600 hover:bg-red-100"}`}
            >
              <div className="flex items-center gap-3">
                <LogOut size={18} />{" "}
          ...
          <button
            ...
            disabled={loading}
            className="mt-6 w-full py-3 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold flex items-center justify-center gap-2"
          >
            {loading ? (
