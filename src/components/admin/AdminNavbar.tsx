    ...
    <nav className="sticky top-0 z-50 px-6 py-4 flex justify-between items-center bg-gray-950/80 backdrop-blur-md border-b border-white/10">
      ...
      <div className="flex items-center gap-3">
         ...
         <h1 className="text-xl font-bold bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">
            BlockVote <span className="text-emerald-500 text-xs uppercase tracking-wider ml-1">Admin</span>
         </h1>
      </div>
          ...
          {isDropdownOpen && (
            ...
            >
              <GlassCard className="p-1 border border-white/10 shadow-xl shadow-black/50">
                 ...
                 <button
                    onClick={() => { setIsDropdownOpen(false); /* Navigate to settings tab via parent if possible, or simple link */ }}
